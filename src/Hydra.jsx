...
const rfAdvantages = [
  {
    ...
    "title": "RF Clarity: Engrave a Crystal-Clear Future",
  ...
  },
  {
    ...
    "title": "Variable-PWM RF — One Laser, Every Task.",
    "copy": "High-frequency, adjustable PWM allows RF lasers to maintain fine detail and high precision during ultra-high-speed engraving. When the frequency is reduced, pulse energy increases dramatically, delivering far stronger penetration. Under the same wattage, RF systems achieve up to 1.85× deeper cuts than glass tubes, combining elite engraving and cutting performance in one.",
  ...
  },
  {
    ...
    "title": "RF Value: Simpler. Safer. Higher ROI",
    "copy": "The air-cooled RF design requires no chiller—eliminating leaks, condensation, tube explosions, and electrical risks while drastically cutting failures and maintenance. Its sealed laser source lasts 20,000–30,000 hours, far outlasting glass tubes with slower decay, less downtime, and near-zero upkeep. No constant tube replacements Cost. Long-term ROI increases dramatically, keeping your machine running and earning.",
