...
The official Hydra 9 Gen2 product page is the source for the embedded All-Material Engraving and Ultra-High-Speed Servo Motor MP4s, their poster frames, and the PID closed-loop comparison images: https://www.1laser.com/products/hydra-9-gen-2-70w-rf-co2-dual-laser-machine. Videos remain user-controlled with visible controls and metadata-only preload.
